...
{
	if (region.aM.af === region.a_.af)
	{
		return 'on line ' + region.aM.af;
	}
	return 'on lines ' + region.aM.af + ' through ' + region.a_.af;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b5: 'hidden', bW: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b5: 'mozHidden', bW: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b5: 'msHidden', bW: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b5: 'webkitHidden', bW: 'webkitvisibilitychange' }
		: { b5: 'hidden', bW: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a2: fragment, a7: host, bi: path, bk: port_, br: protocol, bs: query};
	});
...
var $author$project$Spa$Generated$Route$NotFound = {$: 4};
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {Q: frag, co: params, O: unvisited, d: value, U: visited};
	});
...
var $author$project$Spa$Generated$Route$Counter = {$: 3};
...
var $author$project$Spa$Generated$Route$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Spa$Generated$Route$Counter,
...
var $author$project$Spa$Generated$Pages$Counter__Model = function (a) {
	return {$: 3, a: a};
};
var $author$project$Spa$Generated$Pages$Counter__Msg = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Spa$Page$static = function (page) {
	return {
		...
		aA: $elm$core$Basics$always($elm$core$Basics$identity),
		cx: function (_v1) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aW: col, bY: contextStack, bo: problem, bx: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bx, s.aW, x, s.e));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aW: 1, e: s.e, f: s.f, c: s.c + 1, bx: s.bx + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aW: s.aW + 1, e: s.e, f: s.f, c: newOffset, bx: s.bx, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aW: col, e: s0.e, f: s0.f, c: offset, bx: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.bx, s.aW, s);
	};
};
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.c, s.bx, s.aW, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{aW: newCol, e: s.e, f: s.f, c: newOffset, bx: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.c, s.bx, s.aW, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aW: s.aW + (newOffset - s.c), e: s.e, f: s.f, c: newOffset, bx: s.bx, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bx, s.aW - (floatOffset + s.c), invalid, s.e));
		} else {
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				a9: $elm$core$Result$Ok($elm$core$Basics$identity),
				b8: invalid,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aW: col, bo: problem, bx: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bx, p.aW, p.bo);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aW: 1, e: _List_Nil, f: 1, c: 0, bx: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Pages$About$view = function (_v0) {
	...
	return {
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Components$HtmlRenderer$htmlRenderer($author$project$Content$about.p)
													]))
											]))
									]))
							]))
		...
		aQ: $author$project$Content$about.aQ
	};
};
var $author$project$Pages$About$page = $author$project$Spa$Page$static(
	{cD: $author$project$Pages$About$view});
var $author$project$Content$contact = {p: 'I am happy to hear about possible work orders or potential collaborations. If you would like to see my professional CV, do not hesitate to ask. You can drop me a line on:<br /><br /><span class=\"email-link\"><a href=\"mailto:hello@viktorija.graphics\">hello@viktorija.graphics</a></span><br /><br />You are also welcome to contact me via my social media accounts.', aQ: 'Contact'};
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Components$HtmlRenderer$htmlRenderer($author$project$Content$contact.p)
													]))
											]))
									]))
							]))
...
var $author$project$Pages$Counter$init = function (_v0) {
	var params = _v0.co;
	return {P: 0};
};
...
var $author$project$Pages$Counter$Decrement = 1;
var $author$project$Pages$Counter$Increment = 0;
...
var $author$project$Pages$Counter$page = $author$project$Spa$Page$sandbox(
	{b7: $author$project$Pages$Counter$init, cB: $author$project$Pages$Counter$update, cD: $author$project$Pages$Counter$view});
...
var $author$project$Pages$Projects$Id_String$notFound = {x: _List_Nil, p: _List_Nil, y: 'Not found', z: '', A: _List_Nil, C: 'not_found', b: 'NOT FOUND'};
var $author$project$Content$projects = _List_fromArray(
	[
		...
		y: '<strong>Lorem</strong> ipsum dolor sit amet consectetur, adipisicing elit. Totam consectetur atque unde at numquamaccusantium deleniti nihil <i>error reprehenderit expedita</i> eligendi aliquid dicta quia distinctio, esse culpa minus. <br /> <br /> Cumque, totam. Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita aut in nulla aliquid adipisci corrupti quis fuga ducimus rem aspernatur <a href=\"#\">esse mollitia reprehenderit</a> consequatur minima illum placeat, id libero atque? <br /> <br /> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Atque iusto odit fugiat rem nihil praesentium ullam magnam nemo, debitis, quibusdam laboriosam sunt optio, quod dignissimos repellendus vitae voluptatum eligendi voluptates?',
		z: '/img/letterhead_and_envelope_mockup_hop_brothers.jpg',
		A: _List_fromArray(
			[
				{b: 'Duration', d: 'Around 5 days'},
				{b: 'Date', d: 'YYYY-MM-DD'},
...
var $author$project$Pages$Projects$Id_String$content = function (project) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Components$HtmlRenderer$htmlRenderer(project.y)
						])),
				...
				_List_fromArray(
					[
						...
						$author$project$Pages$Projects$Id_String$presentProject(
							$author$project$Pages$Projects$Id_String$getProject(params.C)))
					]))
			]),
		aQ: 'Viktorija | ' + $author$project$Pages$Projects$Id_String$getProject(params.C).b
	};
};
...
var $author$project$Pages$Top$init = function (_v0) {
	...
	var query = _v0.bs;
	return {
		T: $author$project$Pages$Top$parseQueryString(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src(project.z)
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Pages$Top$isTopLevelGrid = function (grid) {
	if (!grid) {
		return _List_fromArray(
			[
	...
	function (projects, isToplevel) {
		...
		switch (_v0) {
			...
			case 2:
				return A2(
					$author$project$Pages$Top$displayGrid,
					$author$project$Pages$Top$isTopLevelGrid(isToplevel),
					projects);
			default:
				return A2(
					$author$project$Pages$Top$displayGrid,
...
var $author$project$Pages$Top$filterProjects = function (model) {
	return A2(
		$elm$core$List$filter,
		function (x) {
			return A2($elm$core$List$member, model.T, x.x);
		},
		$author$project$Content$projects);
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_Utils_eq(model.T, project) ? $elm$html$Html$Attributes$class('left-menu-item-selected') : $elm$html$Html$Attributes$class('')
				]),
			_List_fromArray(
				[
...
var $author$project$Content$top = {p: 'lorem ipsum dolor sit amet', aQ: 'Main page'};
var $author$project$Pages$Top$view = function (model) {
	return {
		...
		aQ: $author$project$Content$top.aQ
	};
};
var $author$project$Pages$Top$page = $author$project$Spa$Page$sandbox(
	{b7: $author$project$Pages$Top$init, cB: $author$project$Pages$Top$update, cD: $author$project$Pages$Top$view});
	...
	function (params, key, url) {
		return {
			...
			bs: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.bs)),
			cp: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.b7,
						shared,
						A3($author$project$Spa$Url$create, params, shared.b9, shared.cC)));
			});
		...
		return {L: bundle_, b7: init_, cB: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	am: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$About__Model, $author$project$Spa$Generated$Pages$About__Msg, $author$project$Pages$About$page),
	ap: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Contact__Model, $author$project$Spa$Generated$Pages$Contact__Msg, $author$project$Pages$Contact$page),
	P: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Counter__Model, $author$project$Spa$Generated$Pages$Counter__Msg, $author$project$Pages$Counter$page),
	au: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$NotFound__Model, $author$project$Spa$Generated$Pages$NotFound__Msg, $author$project$Pages$NotFound$page),
	ay: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Projects__Id_String__Model, $author$project$Spa$Generated$Pages$Projects__Id_String__Msg, $author$project$Pages$Projects$Id_String$page),
	aB: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Top__Model, $author$project$Spa$Generated$Pages$Top__Msg, $author$project$Pages$Top$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.aB.b7(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.am.b7(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.ap.b7(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.P.b7(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.au.b7(0);
		default:
			var params = route.a;
			return $author$project$Spa$Generated$Pages$pages.ay.b7(params);
	}
};
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.aB.L(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.am.L(model);
		case 2:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.ap.L(model);
		case 3:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.P.L(model);
		case 4:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.au.L(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.ay.L(model);
	}
};
...
var $author$project$Spa$Document$toBrowserDocument = function (doc) {
	return {bU: doc.bU, aQ: doc.aQ};
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).as(0);
};
var $elm$browser$Browser$Navigation$pushUrl = _Browser_pushUrl;
var $author$project$Spa$Generated$Pages$save = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).aA(0);
};
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.aB.cB, msg, model);
					} else {
						break _v0$6;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.am.cB, msg, model);
					} else {
						break _v0$6;
					}
				case 2:
				...
				case 3:
					if (_v0.b.$ === 3) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.P.cB, msg, model);
					} else {
						break _v0$6;
					}
				case 4:
				...
				default:
					if (_v0.b.$ === 5) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.ay.cB, msg, model);
					} else {
						break _v0$6;
					}
			}
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$div, _List_Nil, page.bU)
						]))
				]),
			aQ: page.aQ
		};
