...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				var sharedMsg = msg.a;
				var _v3 = A2($author$project$Shared$update, sharedMsg, model.B);
				var shared = _v3.a;
				var sharedCmd = _v3.b;
